 ...
 *  @brief Brief
 *  
 *  @param [in] serialIn  Parameter_Description
 *  @param [in] serialOut Parameter_Description
 *  @param [in] resetPin  Parameter_Description
 ...
 *  @param [in] serialOut Parameter_Description
 *  @param [in] resetPin  Parameter_Description
 *  @param [in] dbgSerial Parameter_Description
 *  @return Return_Description
 *  
 *  @details Details
 */
 ...
 *  @brief Brief
 *  
 *  @param [in] endSendWithNewline Parameter_Description
 *  @return Return_Description
 *  
 *  @details Details
 */
...
bool ESP8266wifi::begin()
{
    ...
    for(i =0; i<HW_RESET_RETRIES; i++)
        ...
        statusOk = readCommand(3000, READY) == 1;		// Look for ready string from wifi module
        if(statusOk)
            break;
    }
 ...
 *  @param [in] password Parameter_Description
 *  @return Return_Description
 *  
 *  @details Details
 */
 ...
 *  @return Return_Description
 *  
 *  @details Details	Performs a connect retry (or hardware reset) if not connected
 */
bool ESP8266wifi::watchdog() {
	
    if (serverRetries >= SERVER_CONNECT_RETRIES_BEFORE_HW_RESET)
        return restart(); // give up, do a hardware reset
 ...
 *  @param [in] sendNow Parameter_Description
 *  @return Return_Description
 *  
 *  @details Details
 */
 ...
 *  @return Return_Description
 *  
 *  @details Details	Checks to see if there is a client connection
 */
 ...
 *  @brief Brief
 *  
 *  @param [in] pConnections Parameter_Description
 *  @return Return_Description
 *  
 *  @details Details Updates private connections struct and make passed pointer point to data
 */
 ...
 *  @brief Brief
 *  
 *  @param [in] timeout Parameter_Description
 *  @return Return_Description
 *  
 *  @details Details
 */
 ...
 *  @brief Brief
 *  
 *  @param [in] text1 Parameter_Description
 *  @param [in] text2 Parameter_Description
 *  @return Return_Description
 *  
 *  @details Details Writes commands (from PROGMEM) to serial output
 */
...
/**
 *  @brief Brief Reads from serial input until a expected string is found (or until timeout)
 *  
 *  @param [in] timeout Parameter_Description
 *  @param [in] text1   Parameter_Description
 *  @param [in] text2   Parameter_Description
 *  @return Return_Description
 *  
 *  @details Details NOTE: strings are stored in PROGMEM (auto-copied by this method)
 */
 ...
 *  @brief Brief
 *  
 *  @param [in] buf   Parameter_Description
 *  @param [in] count Parameter_Description
 *  @param [in] delim Parameter_Description
 *  @return Return_Description
 *  
 *  @details Details Reads count chars to a buffer, or until delim char is found
 */
 ...
 *  @return Return_Description
 *  
 *  @details Details	Reads a single char from serial input (with debug printout if configured)
 */
char ESP8266wifi::readChar(void) {
