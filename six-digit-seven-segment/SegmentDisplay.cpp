...
SegmentDisplay::SegmentDisplay (uint8_t latchPin, uint8_t clockPin, uint8_t dataPin, int digit1, int digit2, int digit3, int digit4, int digit5, int digit6, int punkt) {
