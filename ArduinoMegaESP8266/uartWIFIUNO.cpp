 ...
 *  @brief Initialize
 *  
 *  @param [byte] mode setting operation mode: STA (Station), AP (Access Point), AT_STA (Access Point & Station)
 *  @param [String] ssid Parameter_Description
 *  @param [String] pwd  Parameter_Description
 *  @param [byte] chl  channel number
 *  @param [byte] ecn  encryption: 0:Open, 1:WEP, 2:WAP_PSK, 3:WAP2_PSK, 4:WAP_WAP2_PSK
 *  @return true - successfully : false - unsuccessfully
 *  
 *  @details Initialize port
 */
 ...
 *  @brief ipConfig
 *  
 *  @param [byte] type	tcp or udp
 *  @param [String] addr ip address
 *  @param [int] port		port number
 *  @param [boolean] a	set multiple connection : 0 for single connection. 1 for multiple connections.
 *  @param [byte] id		id number(0-4)
 *  @return true - successfully : false	-	unsuccessfully
 *  
 *  @details Set up tcp or udp connection
 */
 ...
 *  @return void
 *  
 *  @details reboot the wifi module
 */
 ...
 *  @brief showMode
 *  
 *  @return string of current mode : Station, AP, or AP+Station
 *  
 *  @details inquire the current mode of wifi module
 */
 ...
 *  @brief confMode
 *  
 *  @param [byte] a The mode: 1 Station, 2 AP, 3 AP+Station
 *  @return true	-	successfully : false	-	unsuccessfully
 *  
 *  @details configure the operation mode
 */
 ...
 *  @brief showAP
 *  
 *  @return string of wifi information encryption, SSID, RSSI
 *  
 *  @details show the list of wifi hotspot
 */
String WIFIUNO::showAP(void)
{
	...
	if(data.indexOf("ERROR")!=-1) return "ERROR";
  else
	{
